...
const DesktopNavigation = () => {
    return (
        <nav className='nav-container--desktop'>
            <NavLink to='/user' className='nav-element nav-element--withText' activeClassName='nav-element--withText--selected'>
                <img src={UserIcon} className='icon icon--light' />
                <p className='nav-element__text'>Moje dane</p>
            </NavLink>
            <NavLink to='/charts' className='nav-element nav-element--withText' activeClassName='nav-element--withText--selected'>
                <img src={ChartIcon} className='icon icon--light' />
                <p className='nav-element__text'>Analizuj wydatki</p>
            </NavLink>
            <NavLink to='/add' className='nav-element nav-element--withText' activeClassName='nav-element--withText--selected'>
